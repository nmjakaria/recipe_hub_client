        ...
        <div className="grid min-h-screen grid-cols-1 md:grid-cols-2 bg-zinc-50 dark:bg-zinc-950 transition-colors">
            ...
            <div className="hidden md:block relative p-4 h-screen sticky top-0">
                ...
                >
                    ...
                    <div className="w-full h-full bg-linear-to-tr from-black/50 via-black/10 to-transparent rounded-[2.5rem] flex flex-col justify-end p-10">
                        {/* Floating Glassmorphism Content Card */}
                        <div className="backdrop-blur-md bg-white/10 dark:bg-black/30 p-6 rounded-2xl border border-white/10 max-w-sm shadow-xl">
                            <h2 className="text-2xl font-bold tracking-tight text-white">Cook. Share. Discover.</h2>
                            <p className="mt-1.5 text-sm text-zinc-200/90 leading-relaxed">
                                Join our global community of culinary enthusiasts. Your next favorite recipe is waiting.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* ─── RIGHT SIDE: FORM CONTEXT CHAMBER ─── */}
            <div className="flex flex-col justify-center items-center px-4 py-12 sm:px-6 md:px-12 lg:px-16 bg-zinc-50 dark:bg-zinc-950 transition-colors">
                <Card className="w-full max-w-md p-6 shadow-sm border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 transition-colors">
                    ...
                    <div className="flex flex-col items-center justify-center gap-1 pb-6 border-b border-zinc-100 dark:border-zinc-800 mb-6 text-center">
                        ...
                        <h1 className="text-2xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">Join Recipe Hub</h1>
