...
export default function SignupPage() {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4 py-4">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <RadioGroup defaultValue="user" name="role" onChange={value => setRole(value)} orientation="horizontal">
                            <Radio value="user">
                                ...
                                <Radio.Content>
                                    <Label className="text-zinc-900 dark:text-zinc-100 cursor-pointer">User</Label>
                                </Radio.Content>
                            </Radio>
                        </RadioGroup>
                    </div>
