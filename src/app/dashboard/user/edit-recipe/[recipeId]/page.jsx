    ...
    if (error) {
        return (
            <div className="min-h-[60vh] flex flex-col items-center justify-center text-center p-4 space-y-4">
                ...
                <Button size="sm" color="primary" as={Link} href="/dashboard/user/my-recipes" startContent={<ArrowLeft className="size-3.5" />}>Return To Dashboard</Button>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
            ...
            <div className="flex items-center gap-4 border-b border-default pb-4">
                <Button as={Link} href="/dashboard/user/my-recipes" variant="light" size="sm" isIconOnly>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white dark:bg-zinc-950 border border-default p-6 rounded-2xl shadow-sm">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <Button type="button" size="sm" color="primary" variant="flat" startContent={<Plus className="size-3.5" />} onClick={handleAddIngredient}>
                            Add Entry
                        </Button>
                    </div>
                        ...
                        {ingredients.map((item, index) => (
                            <div key={index} className="flex gap-2 items-center">
                                <Input
                                    ...
                                    required
                                />
                                <Button size="sm" isIconOnly color="danger" variant="light" onClick={() => handleRemoveIngredient(index)}>
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        ...
                        <Button type="button" size="sm" color="primary" variant="flat" startContent={<Plus className="size-3.5" />} onClick={handleAddInstruction}>
                            Add Step
                        </Button>
                    </div>
                    ...
                    <div className="space-y-2">
                        {instructions.map((item, index) => (
                            <div key={index} className="flex gap-2 items-start">
                                ...
                                <Button size="sm" isIconOnly color="danger" variant="light" className="mt-1" onClick={() => handleRemoveInstruction(index)}>
                                    <Trash2 className="size-4" />
                                </Button>
                            </div>
                        ))}
                ...
                <div className="flex items-center justify-end gap-3 border-t border-default pt-4">
                    <Button as={Link} href="/dashboard/user/my-recipes" variant="flat" size="sm" className="font-bold">
                        Cancel Changes
                    </Button>
                    <Button type="submit" color="primary" size="sm" className="font-bold" isLoading={isSaving} startContent={!isSaving && <Save className="size-4" />}>
                        Save Structural Matrix
                    </Button>
                </div>
            </form>
        </div>
