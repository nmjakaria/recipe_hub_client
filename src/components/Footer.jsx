                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8 items-start mb-12">
                    ...
                    <div className="lg:col-span-4 space-y-5">
                        <Link href="/" className="inline-flex items-center gap-2.5 group">
                            <div className="p-2.5 bg-linear-to-br from-orange-300 to-rose-400 rounded-xl shadow-md shadow-orange-500/10 text-white group-hover:rotate-6 transition-transform duration-300">
